package com.moses.library.indicators;
...
import com.moses.library.Indicator;
...
public class SquareSpinIndicator extends Indicator {
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        canvas.drawRect(new RectF(getWidth() / 5f, getHeight() / 5f, getWidth() * 4 / 5f, getHeight() * 4 / 5f), paint);
    }
